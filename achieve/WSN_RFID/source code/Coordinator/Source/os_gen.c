...
PUBLIC void os_vCRD_ZpsEventsTask(void);
PUBLIC void os_vCRD_TickTimerTask(void);
PUBLIC void os_vCRD_AppEpEventsTask(void);
...
tsTask os_Task_CRD_ZpsEventsTask = { OS_TASK_MAGIC, 4, 4, 1, os_vCRD_ZpsEventsTask };
tsTask os_Task_CRD_TickTimerTask = { OS_TASK_MAGIC, 2, 2, 0, os_vCRD_TickTimerTask };
tsTask os_Task_CRD_AppEpEventsTask = { OS_TASK_MAGIC, 3, 3, 0, os_vCRD_AppEpEventsTask };
...
tsSWTimer os_SWTimer_TickCounter_CRD_ZpsEventsTimer = { OS_SWTIMER_MAGIC, NULL, &os_HWCounter_TickCounter, NULL, &os_Task_CRD_ZpsEventsTask, 0, OS_E_SWTIMER_STOPPED, FALSE };
tsSWTimer os_SWTimer_TickCounter_CRD_TickTimer = { OS_SWTIMER_MAGIC, NULL, &os_HWCounter_TickCounter, NULL, &os_Task_CRD_TickTimerTask, 0, OS_E_SWTIMER_STOPPED, FALSE };
