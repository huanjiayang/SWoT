...
PRIVATE uint8 s_au8apduAppEpRxDataInstance0Storage[80];
PRIVATE pdum_tsAPduInstance s_asapduAppEpRxDataInstances[1] = {
    { s_au8apduAppEpRxDataInstance0Storage, 0, 0, 1 },
};
PRIVATE uint8 s_au8apduAppEpTxDataInstance0Storage[80];
PRIVATE pdum_tsAPduInstance s_asapduAppEpTxDataInstances[1] = {
    { s_au8apduAppEpTxDataInstance0Storage, 0, 0, 2 },
};
...
PRIVATE pdum_tsAPdu s_asAPduPool[3] = {
    ...
    { s_asapduAppEpRxDataInstances, 0, 80, 1},
    { s_asapduAppEpTxDataInstances, 0, 80, 1},
};
...
PUBLIC void PDUM_vInit(void)
{
    ...
    asm(".globl _pdum_apduAppEpRxData" : );
    asm("_pdum_apduAppEpRxData=_s_asAPduPool + 12" : );
    asm(".globl _pdum_apduAppEpTxData" : );
    asm("_pdum_apduAppEpTxData=_s_asAPduPool + 24" : );
