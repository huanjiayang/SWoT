...
/* Task Handles */
#define RTR_ZpsEventsTask ((OS_thTask)&os_Task_RTR_ZpsEventsTask)
#define RTR_TickTimerTask ((OS_thTask)&os_Task_RTR_TickTimerTask)
#define RTR_AppEpEventsTask ((OS_thTask)&os_Task_RTR_AppEpEventsTask)
...
#define RTR_ZpsEventsTimer ((OS_thSWTimer)&os_SWTimer_TickCounter_RTR_ZpsEventsTimer)
#define RTR_TickTimer ((OS_thSWTimer)&os_SWTimer_TickCounter_RTR_TickTimer)
...
/* Task Handles */
PUBLIC OS_thTask os_Task_RTR_ZpsEventsTask;
PUBLIC OS_thTask os_Task_RTR_TickTimerTask;
PUBLIC OS_thTask os_Task_RTR_AppEpEventsTask;
...
PUBLIC OS_thSWTimer os_SWTimer_TickCounter_RTR_ZpsEventsTimer;
PUBLIC OS_thSWTimer os_SWTimer_TickCounter_RTR_TickTimer;
