...
PRIVATE uint8 s_au8apduSensorDataInstance1Storage[13];
PRIVATE uint8 s_au8apduSensorDataInstance2Storage[13];
PRIVATE uint8 s_au8apduSensorDataInstance3Storage[13];
PRIVATE pdum_tsAPduInstance s_asapduSensorDataInstances[4] = {
    { s_au8apduSensorDataInstance0Storage, 0, 0, 1 },
    { s_au8apduSensorDataInstance1Storage, 0, 0, 1 },
    { s_au8apduSensorDataInstance2Storage, 0, 0, 1 },
    { s_au8apduSensorDataInstance3Storage, 0, 0, 1 },
};
PRIVATE uint8 s_au8apduLedControlInstance0Storage[10];
PRIVATE uint8 s_au8apduLedControlInstance1Storage[10];
PRIVATE uint8 s_au8apduLedControlInstance2Storage[10];
PRIVATE uint8 s_au8apduLedControlInstance3Storage[10];
PRIVATE uint8 s_au8apduLedControlInstance4Storage[10];
PRIVATE pdum_tsAPduInstance s_asapduLedControlInstances[5] = {
    { s_au8apduLedControlInstance0Storage, 0, 0, 2 },
    { s_au8apduLedControlInstance1Storage, 0, 0, 2 },
    { s_au8apduLedControlInstance2Storage, 0, 0, 2 },
    { s_au8apduLedControlInstance3Storage, 0, 0, 2 },
    { s_au8apduLedControlInstance4Storage, 0, 0, 2 },
};
...
PRIVATE pdum_tsAPdu s_asAPduPool[3] = {
    ...
    { s_asapduSensorDataInstances, 0, 13, 4},
    { s_asapduLedControlInstances, 0, 10, 5},
};
