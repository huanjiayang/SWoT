...
/* ZDO Servers */
PRIVATE zps_tsAplZdoServer s_asAplZdoServers[18] = {
...
PRIVATE uint16 s_au16Endpoint1InputClusterList[2] = { 0xa000, 0xffff, };
PRIVATE PDUM_thAPdu s_ahEndpoint1InputClusterAPdus[2] = { apduSensorData, apduSensorData, };
PRIVATE uint8 s_au8Endpoint1InputClusterDiscFlags[1] = { 0x03 };

PRIVATE uint16 s_au16Endpoint2InputClusterList[1] = { 0xa001, };
PRIVATE PDUM_thAPdu s_ahEndpoint2InputClusterAPdus[1] = { apduLedControl, };
...
/* APSDE sync msg pool */
PRIVATE zps_tsMsgRecord s_asApsSyncMsgPool[15];

/* APSDE dcfm record pool */
PRIVATE zps_tsDcfmRecord s_asApsDcfmRecordPool[15];
...
/* Trust Center */
static zps_tsAplTCDeviceTable s_asTrustCenterDeviceTable[5];
static zps_tsRequestKeyRequests s_asRequestKeyRequests[2];
static zps_tsTrustCenterContext s_sTrustCenterContext = {
    zps_vAplTrustCenterInit,
    zps_vAplTrustCenterUpdateDevice,
    zps_vAplTrustCenterRequestKey,
    { s_asTrustCenterDeviceTable, 5 },
