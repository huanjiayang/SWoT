...
#define ZPS_NODE_AN1122_ZBP_CONTROLLERNODE
...
/* Profile 'JENNIC_HSD' */
#define JENNIC_HSD_PROFILE_ID    (0x04d2)
#define JENNIC_HSD_SENSOR_DATA_CLUSTER_ID    (0xa000)
#define JENNIC_HSD_LED_CONTROL_CLUSTER_ID    (0xa001)
#define JENNIC_HSD_DEFAULT_CLUSTER_ID    (0xffff)

/* Node 'AN1122_ZBP_ControllerNode' */
/* Endpoints */
#define AN1122_ZBP_CONTROLLERNODE_ZDO_ENDPOINT    (0)
#define AN1122_ZBP_CONTROLLERNODE_SENSOR_ENDPOINT    (1)
#define AN1122_ZBP_CONTROLLERNODE_LED_CONTROL_ENDPOINT    (2)

/* Node 'AN1122_ZBP_SensorNode' */

/* Endpoints */
#define AN1122_ZBP_SENSORNODE_ZDO_ENDPOINT    (0)
#define AN1122_ZBP_SENSORNODE_SENSOR_ENDPOINT    (1)
#define AN1122_ZBP_SENSORNODE_LED_CONTROL_ENDPOINT    (2)

/* Node 'AN1122_ZBP_SensorNode_SED' */

/* Endpoints */
#define AN1122_ZBP_SENSORNODE_SED_ZDO_ENDPOINT    (0)
#define AN1122_ZBP_SENSORNODE_SED_SENSOR_ENDPOINT    (1)
#define AN1122_ZBP_SENSORNODE_SED_LED_CONTROL_ENDPOINT    (2)
