 ...
 *
 * $HeadURL: https://www.collabnet.nxp.com/svn/lprf_sware/Application_Notes/JN-AN-1122-ZBPro-Home-Sensor-Demo/Tags/ZBPRO-HOME-SENSOR-DEMO_1v7_RC4/AN1122_ZBP_SensorNode_SED/Source/app_start.c $
 *
 * $Revision: 29685 $
 *
...
PRIVATE const tsReg128 g_sKey = { 0x899698D7, 0x3074B750, 0x1E3361E9, 0x8CE035CD };
#ifdef OVERLAYS_BUILD
...
PWRM_CALLBACK(PreSleep)
{
    ...
    /* Clear any Dio interrupt flags */
    (void)u32AHI_DioInterruptStatus();

    /* Turn LED1 off to indicate device sleeping */
    APP_vLedSet(1, FALSE);
#ifdef OVERLAYS_BUILD
    bOvlyInit = FALSE;
#endif
...
PWRM_CALLBACK(Wakeup)
{
    ...
    /* Turn on LED 1 to indicate device awake and sending */
    APP_vLedSet(1, TRUE);
    ...
    DBG_vPrintf(TRACE_APP, "APP: Restarting OS\n");
    OS_vRestart();
}
