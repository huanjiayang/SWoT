...
tsTask os_Task_APP_taskSampleSensors = { OS_TASK_MAGIC, 3, 3, 0, os_vAPP_taskSampleSensors };
tsTask os_Task_APP_taskSensorNode = { OS_TASK_MAGIC, 2, 2, 1, os_vAPP_taskSensorNode };
tsTask os_Task_APP_taskScanButtons = { OS_TASK_MAGIC, 5, 5, 0, os_vAPP_taskScanButtons };
tsTask os_Task_APP_taskLedControl = { OS_TASK_MAGIC, 4, 4, 0, os_vAPP_taskLedControl };
...
tsMutex os_Mutex_mutexMEDIA = { OS_MUTEX_MAGIC, 3, 0, 0xff, 0xff };
...
PUBLIC void OS_vStart(void (*prvInitFunction)(void), void (*prvUnclaimedISR)(void))
{
    ...
    os_vPatchInit();
    os_vStart(prvInitFunction, prvUnclaimedISR, 0x40000000, s_asTasks, 15, os_OSMIUM_HwVectTable, os_PIC_ChannelPriorities);
}
