 ...
 *
 * $HeadURL: https://www.collabnet.nxp.com/svn/lprf_sware/Application_Notes/JN-AN-1122-ZBPro-Home-Sensor-Demo/Tags/ZBPRO-HOME-SENSOR-DEMO_1v7_RC4/AN1122_ZBP_SensorNode_SED/Source/app_sensor_node_SED.c $
 *
 * $Revision: 29654 $
 *
 ...
 *
 * $Id: app_sensor_node_SED.c 29654 2011-03-01 14:54:11Z nxp29741 $
 *
 *****************************************************************************
 *
...
{
    DBG_vPrintf(TRACE_APP, "APP: vWakeCallBack called\n");
    ZPS_eAplZdoPoll();
    ...
    if (ZPS_EVENT_NONE != sStackEvent.eType)
    {
        switch (sStackEvent.eType)
        {
            ...
            case ZPS_EVENT_APS_DATA_CONFIRM:
                ...
                /* request a 1 second sleep */
                int i = PWRM_eScheduleActivity(&sWake, 1 * 32000 , vWakeCallBack);
                DBG_vPrintf(TRACE_APP_PWRM, "Scheduling Sleep point in 1 second, status = %d\n", i);
                break;
            ...
            case ZPS_EVENT_APS_DATA_ACK:
                DBG_vPrintf(TRACE_APP, "APP: Monitor Sensors ZPS_EVENT_APS_DATA_ACK\n");
                break;
             ...
             case ZPS_EVENT_NWK_POLL_CONFIRM:
                 DBG_vPrintf(TRACE_APP, "APP: Monitor Sensors ZPS_EVENT_NWK_POLL_CONFIRM status=%d\n",
                         sStackEvent.uEvent.sNwkPollConfirmEvent.u8Status );
                 break;

            default:
                DBG_vPrintf(TRACE_APP, "Monitor Sensors unhandled event %d\n", sStackEvent.eType);
                break;
