...
/* Profile 'JENNIC_WUART' */
#define JENNIC_WUART_PROFILE_ID    (0x1134)
#define JENNIC_WUART_APP_CLUSTER_ID    (0x4311)

/* Node 'WUART_COORDINATOR' */
/* Endpoints */
#define WUART_COORDINATOR_ZDO_ENDPOINT    (0)
#define WUART_COORDINATOR_APP_ENDPOINT    (34)

/* Node 'WUART_ROUTER' */

/* Endpoints */
#define WUART_ROUTER_ZDO_ENDPOINT    (0)
#define WUART_ROUTER_APP_ENDPOINT    (34)
